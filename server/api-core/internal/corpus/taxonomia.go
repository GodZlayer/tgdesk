...
var Catalogo = []Problema{
	...
	},
	{
		...
		Produz:        []string{"trava_sob_carga", "desligamento_inesperado", "corrupcao_de_dados", "nao_inicializa", "congelamento_breve_repetido"},
	...
	},
	{
		...
		Produz:        []string{"trava_sob_carga", "desligamento_inesperado", "congelamento_breve_repetido"},
	...
	// --- Tipo 2: peça insuficiente ---------------------------------------
	{
		...
		Produz:        []string{"lentidao_profunda", "congelamento_breve_repetido"},
	...
	// --- Tipo 3: peça mal condicionada -----------------------------------
	{
		...
		Produz:        []string{"superaquecimento", "lentidao_intermitente", "trava_sob_carga", "desligamento_inesperado", "congelamento_breve_repetido"},
	...
	},
	{
		...
		Sinais:        []string{"driver_falho", "bugcheck"},
		Produz:        []string{"desligamento_inesperado", "trava_sob_carga", "lentidao_intermitente", "congelamento_breve_repetido"},
