		...
		"sections": []map[string]any{
			{
				...
				"title":         "Auditoria",
				"kind":          "live_pdf_log",
				"description":   "Log separado por dom?nio e rela??o para relat?rio live, PDF interativo, compliance e capta??o.",
				...
				"relations":     []string{"conex?es", "v?nculos", "financeiro", "OS", "diagn?stico", "territ?rio", "seguran?a"},
			},
			{
				"key":         "territory",
				"title":       "Regiões",
