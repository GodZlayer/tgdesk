...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete TG Desk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), TG Desk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare TG Desk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a TG Desk il permesso 'AccessibilitÃ '."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a TG Desk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "AffinchÃ© un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a TG Desk di usare il servizio 'AccessibilitÃ '."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirÃ  di seguito, trova e accedi a [Servizi installati], attiva il servizio [TG Desk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep TG Desk background service", "Mantieni il servizio di TG Desk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione TG Desk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show TG Desk", "Visualizza TG Desk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, Ã¨ necessario concedere le autorizzazioni a TG Desk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, Ã¨ necessario concedere l'autorizzazione 'Registra audio' a TG Desk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di TG Desk."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password TG Desk"),
        ("remember_account_tip", "Ricorda questo account"),
        ("os_account_desk_tip", "Questo account viene usato per accedere al sistema operativo remoto e attivare la sessione desktop in modalitÃ  non presidiata."),
        ("OS Account", "Account sistema operativo"),
        ("another_user_login_title_tip", "Ãˆ giÃ  loggato un altro utente."),
        ("another_user_login_text_tip", "Separato"),
        ("xorg_not_found_title_tip", "Xorg non trovato."),
        ("xorg_not_found_text_tip", "Installa Xorg."),
        ("no_desktop_title_tip", "Non Ã¨ presente alcun ambiente desktop disponibile."),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare TG Desk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna TG Desk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo Ã¨ abilitato SELinux, che potrebbe impedire il corretto funzionamento di TG Desk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da TG Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra TG Desk Ã¨ aperta"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client TG Desk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, TG Desk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, TG Desk salterÃ  il passaggio di verifica e procederÃ  in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione Ã¨ abilitata, TG Desk non userÃ  piÃ¹ UDP 21116, verrÃ  invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server TG Desk non include questa funzionalitÃ ."),
