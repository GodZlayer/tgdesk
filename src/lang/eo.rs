...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto TG Desk..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aÅ­ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali TG Desk sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al TG Desk."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al TG Desk."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aÅ­ tuÅo, vi devas permesi al TG Desk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paÄo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], Åalti la servon [TG Desk Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep TG Desk background service", "Tenu TG Desk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malÅalti Ä‰i tiun funkcion, bonvolu iri al la sekva paÄo de agordoj de la aplikaÄµo de TG Desk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Full Access", ""),
        ("Screen Share", ""),
        ("Wayland requires Ubuntu 21.04 or higher version.", "Wayland postulas Ubuntu 21.04 aÅ­ pli altan version."),
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland postulas pli altan version de linuksa distro. Bonvolu provi X11-labortablon aÅ­ ÅanÄi vian OS."),
        ("JumpLink", "View"),
