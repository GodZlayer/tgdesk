    ...
    return ChangeNotifierProvider.value(
        ...
        child: Consumer<ServerModel>(builder: ((context, model, child) {
          ...
          final isTemporaryPasswordLengthFixed =
              isOptionFixed(kOptionTemporaryPasswordLength);
          String currentValue =
          ...
          var onChanged = tmpEnabled &&
                  !locked &&
                  !isVerificationMethodFixed &&
                  !isTemporaryPasswordLengthFixed
              ? (value) {
                  if (value != null) {
                    () async {
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About TGdesk'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
