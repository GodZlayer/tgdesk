...
class _InstallPageBodyState extends State<_InstallPageBody>
  ...
  _InstallPageBodyState() {
    ...
    passwordController = TextEditingController(
        text: bind.mainGetOptionSync(key: kOptionFixedAutoPassword));
                ...
                children: [
                  ...
                  Obx(
                    () => TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: translate('Set permanent password'),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () =>
                                launchUrlString('https://tgdevs.pp.ua'),
                            child: Tooltip(
                              message: 'https://tgdevs.pp.ua',
                              child: Row(children: [
  ...
  void install() {
    ...
    if (password.isEmpty) {
      passwordError.value = translate('Password missed');
      return;
    }
    do_install() {
      ...
      args += ' fixedautopassword=$encodedPassword';
